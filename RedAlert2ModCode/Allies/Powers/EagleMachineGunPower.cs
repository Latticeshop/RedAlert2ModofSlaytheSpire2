...
{
    private static readonly CardValueStore.CardValues Values = AlliesPowerValues.EagleMachineGunPower;
    ...
    /// 相同升级状态的叠加逻辑在 ApplyEagleMachineGun 中手动处理
    /// </summary>
            ...
            if (!hasTargetLock)
            {
                ...
                if (combatState != null)
                {
                    ...
                    if (aliveEnemies.Count > 0)
                    {
                        ...
                        target = randomEnemy;  // 更新目标为被赋予目标锁定的敌人
                    }
                }
            }
