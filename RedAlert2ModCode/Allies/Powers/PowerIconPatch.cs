...
public static class PowerIconPatch
{
    ...
    private static readonly Dictionary<Type, string> _customIconPaths = new()
    {
        ...
        { typeof(RedAlert2ModCode.Soviet.Powers.HelicopterTemporaryDexterityPower), "res://RedAlert2ModResources/images/packed/card_portraits/soviet/schpicon.png" },
        ...
        { typeof(RedAlert2ModCode.Soviet.Powers.SpyPlaneTemporaryDexterityPower), "res://RedAlert2ModResources/images/packed/card_portraits/soviet/spypicon.png" },
