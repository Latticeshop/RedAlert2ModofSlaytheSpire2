...
public class StealthCrate : CardModel
{
    private static readonly CardValueStore.CardValues Values = CommonCardValues.StealthCrate;

    public StealthCrate() : base((int)Values.Cost, CardType.Skill, CardRarity.Token, TargetType.Self) {}
