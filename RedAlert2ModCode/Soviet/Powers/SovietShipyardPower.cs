...
public sealed class SovietShipyardPower : PowerModel
{
    ...
    public new string PackedIconPath => "res://RedAlert2ModResources/images/packed/card_portraits/soviet/yardicon.png";
}